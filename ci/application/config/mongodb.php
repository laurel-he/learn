...
$config['mongo_host'] = $_SERVER['MONGO_SS_HOST'];

// Generally will be 27017 unless you've configured Mongo otherwise
$config['mongo_port'] = $_SERVER['MONGO_SS_PORT'];

// The database you want to work from (required)
$config['mongo_db'] = $_SERVER['MONGO_SS_NAME'];

// Leave blank if Mongo is not running in auth mode
$config['mongo_user'] = $_SERVER['MONGO_SS_USER​​​'];
$config['mongo_pass'] = $_SERVER['MONGO_SS_PASS​​​​​'];
